...
while True:
    ...
    if (
        operator not in operator_perm
    ):  # se o operador selecionado não está entre os permitidos, imprima e continue novamente
    ...
    sair = (
        input("Quer sair? [s]im: ").lower().startswith("s")
    )  # converte para minúsculo e verifica se começa com 's' -> bool
