...
# copiando
shutil.copytree(MY_FOLDER, NEW_FOLDER)
# movendo para outra pasta no mesmo caminho só que com outro nome
shutil.move(NEW_FOLDER, NEW_FOLDER + '_nome da pasta nova')
