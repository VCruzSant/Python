...
path = os.path.join('Python', 'modules', 'file.txt')
print(path)

# split separa o diretorio do caminho
directory, file = os.path.split(path)
print(directory, ',', file)

# esse caminho existe?
print(os.path.exists('C:\\codando 1\\Python'))

# caminho absoluto -> colocando '.', ele mostra o caminho da pasta
print(os.path.abspath('.'))
my_p = os.path.abspath('.')

# parte final do caminho
print(os.path.basename(path))

# pegando a basename do diretório inventado na variavel path:
print(os.path.basename(directory))

# dirname -> começo do diretório
print(os.path.dirname(my_p))
